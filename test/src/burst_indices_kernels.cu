...
namespace alus {
namespace tests {
__global__ void ComputeBurstIndicesKernel(double line_time_interval, double wavelength, int num_of_bursts,
                                          ...
                                          const double dt, backgeocoding::BurstIndices* indices) {
    ...
    indices[thread_id] =
        backgeocoding::GetBurstIndices(line_time_interval, wavelength, num_of_bursts, burst_first_line_times,
                                       burst_last_line_times, earth_point, orbit, num_orbit_vec, dt);
}
...
cudaError_t LaunchComputeBurstIndicesKernel(double line_time_interval, double wavelength, int num_of_bursts,
                                            ...
                                            dim3 block_dim) {
    ComputeBurstIndicesKernel<<<grid_dim, block_dim>>>(line_time_interval, wavelength, num_of_bursts,
                                                       burst_first_line_times, burst_last_line_times, earth_point,
                                                       orbit, num_orbit_vec, dt, indices);
