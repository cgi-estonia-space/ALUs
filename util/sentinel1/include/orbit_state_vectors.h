...
class OrbitStateVectors {
   public:
    ...
    OrbitStateVectors(std::vector<snapengine::OrbitStateVector> orbit_state_vectors,
   ...
   private:
    ...
    static std::vector<snapengine::OrbitStateVector> RemoveRedundantVectors(std::vector<snapengine::OrbitStateVector>
        orbit_state_vectors);
};
