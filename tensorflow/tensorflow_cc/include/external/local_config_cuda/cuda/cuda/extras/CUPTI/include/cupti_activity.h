/*
 * Copyright 2011-2019 NVIDIA Corporation.  All rights reserved.
 *
 * NOTICE TO LICENSEE:
 *
...
typedef enum {
   ...
   * The corresponding activity record structure is \ref CUpti_ActivityKernel4.
   */
...
* gpu<->gpu or gpu<->CPU which can be used to understand the topology.
* NvLink information are now reported using the
* CUpti_ActivityNvLink3 activity record.
*/
...
typedef struct PACKED_ALIGNMENT {
    ...
    union {
      struct {
        /**
         * UUID for the device. \ref CUpti_ActivityDevice2.
         */
        CUuuid    uuidDev;
        /**
