...
#define __SATF_DEPRECATION__  __DEPRECATED__("The satf (saturate to finite value) parameter is deprecated for __half types and may lead to undefined results. It may be removed in a future release.")
