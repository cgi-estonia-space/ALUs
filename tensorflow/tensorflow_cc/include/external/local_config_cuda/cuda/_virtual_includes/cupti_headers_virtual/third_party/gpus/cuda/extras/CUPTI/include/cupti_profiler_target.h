...
typedef struct CUpti_Profiler_CounterDataImage_CalculateSize_Params
{
    ...
    const CUpti_Profiler_CounterDataImageOptions* pOptions;     //!< [in] Pointer to CUpti_Profiler_CounterDataImageOptions
...
#define CUpti_Profiler_SetConfig_Params_STRUCT_SIZE                  CUPTI_PROFILER_STRUCT_SIZE(CUpti_Profiler_SetConfig_Params, passIndex)
...
#define CUpti_Profiler_EndPass_Params_STRUCT_SIZE                  CUPTI_PROFILER_STRUCT_SIZE(CUpti_Profiler_EndPass_Params, ctx)
...
#define CUpti_Profiler_IsPassCollected_Params_STRUCT_SIZE                  CUPTI_PROFILER_STRUCT_SIZE(CUpti_Profiler_IsPassCollected_Params, ctx)
...
#define CUpti_Profiler_FlushCounterData_Params_STRUCT_SIZE                  CUPTI_PROFILER_STRUCT_SIZE(CUpti_Profiler_FlushCounterData_Params, ctx)
