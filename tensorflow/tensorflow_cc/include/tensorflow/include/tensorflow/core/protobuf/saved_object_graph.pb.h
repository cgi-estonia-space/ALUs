...
enum FunctionSpec_ExperimentalCompile : int {
  FunctionSpec_ExperimentalCompile_DEFAULT = 0,
  FunctionSpec_ExperimentalCompile_ON = 1,
  FunctionSpec_ExperimentalCompile_OFF = 2,
  FunctionSpec_ExperimentalCompile_FunctionSpec_ExperimentalCompile_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  FunctionSpec_ExperimentalCompile_FunctionSpec_ExperimentalCompile_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool FunctionSpec_ExperimentalCompile_IsValid(int value);
constexpr FunctionSpec_ExperimentalCompile FunctionSpec_ExperimentalCompile_ExperimentalCompile_MIN = FunctionSpec_ExperimentalCompile_DEFAULT;
constexpr FunctionSpec_ExperimentalCompile FunctionSpec_ExperimentalCompile_ExperimentalCompile_MAX = FunctionSpec_ExperimentalCompile_OFF;
constexpr int FunctionSpec_ExperimentalCompile_ExperimentalCompile_ARRAYSIZE = FunctionSpec_ExperimentalCompile_ExperimentalCompile_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* FunctionSpec_ExperimentalCompile_descriptor();
template<typename T>
inline const std::string& FunctionSpec_ExperimentalCompile_Name(T enum_t_value) {
  static_assert(::std::is_same<T, FunctionSpec_ExperimentalCompile>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function FunctionSpec_ExperimentalCompile_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    FunctionSpec_ExperimentalCompile_descriptor(), enum_t_value);
}
inline bool FunctionSpec_ExperimentalCompile_Parse(
    const std::string& name, FunctionSpec_ExperimentalCompile* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<FunctionSpec_ExperimentalCompile>(
    FunctionSpec_ExperimentalCompile_descriptor(), name, value);
}
// ===================================================================
...
class FunctionSpec :
 ...
 public:
  ...
  typedef FunctionSpec_ExperimentalCompile ExperimentalCompile;
  static constexpr ExperimentalCompile DEFAULT =
    FunctionSpec_ExperimentalCompile_DEFAULT;
  static constexpr ExperimentalCompile ON =
    FunctionSpec_ExperimentalCompile_ON;
  static constexpr ExperimentalCompile OFF =
    FunctionSpec_ExperimentalCompile_OFF;
  static inline bool ExperimentalCompile_IsValid(int value) {
    return FunctionSpec_ExperimentalCompile_IsValid(value);
  }
  static constexpr ExperimentalCompile ExperimentalCompile_MIN =
    FunctionSpec_ExperimentalCompile_ExperimentalCompile_MIN;
  static constexpr ExperimentalCompile ExperimentalCompile_MAX =
    FunctionSpec_ExperimentalCompile_ExperimentalCompile_MAX;
  static constexpr int ExperimentalCompile_ARRAYSIZE =
    FunctionSpec_ExperimentalCompile_ExperimentalCompile_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  ExperimentalCompile_descriptor() {
    return FunctionSpec_ExperimentalCompile_descriptor();
  }
  template<typename T>
  static inline const std::string& ExperimentalCompile_Name(T enum_t_value) {
    static_assert(::std::is_same<T, ExperimentalCompile>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function ExperimentalCompile_Name.");
    return FunctionSpec_ExperimentalCompile_Name(enum_t_value);
  }
  static inline bool ExperimentalCompile_Parse(const std::string& name,
      ExperimentalCompile* value) {
    return FunctionSpec_ExperimentalCompile_Parse(name, value);
  }
  ...
  enum : int {
    ...
    kExperimentalCompileFieldNumber = 6,
  };
  ...
  void clear_experimental_compile();
  ::tensorflow::FunctionSpec_ExperimentalCompile experimental_compile() const;
  void set_experimental_compile(::tensorflow::FunctionSpec_ExperimentalCompile value);
...
// .tensorflow.FunctionSpec.ExperimentalCompile experimental_compile = 6;
inline void FunctionSpec::clear_experimental_compile() {
  experimental_compile_ = 0;
}
inline ::tensorflow::FunctionSpec_ExperimentalCompile FunctionSpec::experimental_compile() const {
  // @@protoc_insertion_point(field_get:tensorflow.FunctionSpec.experimental_compile)
  return static_cast< ::tensorflow::FunctionSpec_ExperimentalCompile >(experimental_compile_);
}
inline void FunctionSpec::set_experimental_compile(::tensorflow::FunctionSpec_ExperimentalCompile value) {
  
  experimental_compile_ = value;
  // @@protoc_insertion_point(field_set:tensorflow.FunctionSpec.experimental_compile)
}
...
template <> struct is_proto_enum< ::tensorflow::FunctionSpec_ExperimentalCompile> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::tensorflow::FunctionSpec_ExperimentalCompile>() {
  return ::tensorflow::FunctionSpec_ExperimentalCompile_descriptor();
}
