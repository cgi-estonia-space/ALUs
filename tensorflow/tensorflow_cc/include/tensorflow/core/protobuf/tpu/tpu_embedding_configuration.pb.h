...
class TPUEmbeddingConfiguration_TableDescriptor :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 vocabulary_size() const;
  void set_vocabulary_size(::PROTOBUF_NAMESPACE_ID::int32 value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 vocabulary_size_;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TPUEmbeddingConfiguration_TableDescriptor::vocabulary_size() const {
...
inline void TPUEmbeddingConfiguration_TableDescriptor::set_vocabulary_size(::PROTOBUF_NAMESPACE_ID::int32 value) {
