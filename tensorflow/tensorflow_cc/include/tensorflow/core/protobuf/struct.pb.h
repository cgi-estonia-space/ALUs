...
enum TypeSpecProto_TypeSpecClass : int {
  ...
  TypeSpecProto_TypeSpecClass_NDARRAY_SPEC = 11,
...
constexpr TypeSpecProto_TypeSpecClass TypeSpecProto_TypeSpecClass_TypeSpecClass_MAX = TypeSpecProto_TypeSpecClass_NDARRAY_SPEC;
...
class TypeSpecProto :
 ...
 public:
  ...
  static constexpr TypeSpecClass NDARRAY_SPEC =
    TypeSpecProto_TypeSpecClass_NDARRAY_SPEC;
