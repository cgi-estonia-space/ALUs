...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_tensorflow_2fcore_2fframework_2fresource_5fhandle_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::tensorflow::ResourceHandleProto, allowed_devices_),
};
...
const char descriptor_table_protodef_tensorflow_2fcore_2fframework_2fresource_5fhandle_2eproto[] =
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fframework_2fresource_5fhandle_2eproto = {
  &descriptor_table_tensorflow_2fcore_2fframework_2fresource_5fhandle_2eproto_initialized, descriptor_table_protodef_tensorflow_2fcore_2fframework_2fresource_5fhandle_2eproto, "tensorflow/core/framework/resource_handle.proto", 607,
...
class ResourceHandleProto_DtypeAndShape::HasBitSetters {
 public:
...
ResourceHandleProto_DtypeAndShape::HasBitSetters::shape(const ResourceHandleProto_DtypeAndShape* msg) {
  return *msg->shape_;
}
...
void ResourceHandleProto_DtypeAndShape::Swap(ResourceHandleProto_DtypeAndShape* other) {
  ...
  if (GetArenaNoVirtual() == other->GetArenaNoVirtual()) {
    ...
    ResourceHandleProto_DtypeAndShape* temp = New(GetArenaNoVirtual());
...
const int ResourceHandleProto::kAllowedDevicesFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900
    ...
    switch (tag >> 3) {
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 58)) {
          ...
          do {
            ptr += 1;
            ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8(add_allowed_devices(), ptr, ctx, "tensorflow.ResourceHandleProto.allowed_devices");
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
    ...
    switch (::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 7: {
        if (static_cast< ::PROTOBUF_NAMESPACE_ID::uint8>(tag) == (58 & 0xFF)) {
          DO_(::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::ReadString(
                input, this->add_allowed_devices()));
          DO_(::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
            this->allowed_devices(this->allowed_devices_size() - 1).data(),
            static_cast<int>(this->allowed_devices(this->allowed_devices_size() - 1).length()),
            ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE,
            "tensorflow.ResourceHandleProto.allowed_devices"));
        } else {
          goto handle_unusual;
        }
        break;
...
void ResourceHandleProto::SerializeWithCachedSizes(
  ...
  // repeated string allowed_devices = 7;
  for (int i = 0, n = this->allowed_devices_size(); i < n; i++) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->allowed_devices(i).data(), static_cast<int>(this->allowed_devices(i).length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "tensorflow.ResourceHandleProto.allowed_devices");
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteString(
      7, this->allowed_devices(i), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* ResourceHandleProto::InternalSerializeWithCachedSizesToArray(
  ...
  for (int i = 0, n = this->allowed_devices_size(); i < n; i++) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "tensorflow.ResourceHandleProto.allowed_devices");
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      WriteStringToArray(7, this->allowed_devices(i), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:tensorflow.ResourceHandleProto)
  ...
  // repeated string allowed_devices = 7;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(this->allowed_devices_size());
  for (int i = 0, n = this->allowed_devices_size(); i < n; i++) {
...
void ResourceHandleProto::InternalSwap(ResourceHandleProto* other) {
  ...
  allowed_devices_.InternalSwap(CastToBase(&other->allowed_devices_));
