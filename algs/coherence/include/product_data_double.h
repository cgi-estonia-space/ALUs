 ...
 * ported for native code. Copied from a snap-engine's(https://github.com/senbox-org/snap-engine) repository originally stated
...
class Double : public ProductData {
   ...
   public:
     ...
     */
    explicit Double(std::vector<double> array);
