...
public:
    ...
    virtual void SetInputFilenames([[maybe_unused]] const std::string& input_dataset,
                                   [[maybe_unused]] const std::string&
                                       metadata_path) { /* Either one of the SetInputFilenames() or SetInputDataset()
                                                           must be implemented, can be both too.*/
    }
    virtual void SetInputDataset([[maybe_unused]] GDALDataset* input,
                                 [[maybe_unused]] const std::string&
                                     metadata_path) { /* Either one of the SetInputFilenames() or SetInputDataset() must
