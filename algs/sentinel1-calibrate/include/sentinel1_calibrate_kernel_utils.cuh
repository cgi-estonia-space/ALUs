...
inline __device__ __host__ void SetupTileLineImpl(int y, CalibrationKernelArgs& args,
    ...
    const auto calibration_vector_index = GetCalibrationVectorIndexImpl(
        y_with_offset, args.calibration_info.line_values.size, args.calibration_info.line_values.array);
