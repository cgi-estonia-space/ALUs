...
void ThreadController::startThreads() {
    ...
    for (algoData.tileXo = 0; algoData.tileXo < algoData.rasterX;
         algoData.tileXo += algoData.tileX) {
        for (algoData.tileYo = 0; algoData.tileYo < algoData.rasterY;
             algoData.tileYo += algoData.tileY) {
            this->computeTileActual(algoData.rasterX, algoData.rasterY,
                                    algoData.tileX, algoData.tileY,
...
void ThreadController::computeTileActual(int rasterX, int rasterY, int tileX,
                                         int tileY, int tileXo, int tileYo,
                                         int& tileXa, int& tileYa) {
