 ...
 */
double GetEarthPointZeroDopplerTime(double first_line_utc, double line_time_interval, double wavelength,
 ...
 */
double ComputeSlantRange(double time, cuda::KernelArray<snapengine::OrbitStateVectorComputation> vectors,
 ...
 * @todo part of the logic is not implemented as it is only used for very long images such as GM, WSM or assembled
 * slices which is not the case in test data provided
 */
